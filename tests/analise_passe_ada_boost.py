...
# x_axis: numpy.ndarray = numpy.linspace(start=1e-3, stop=250e-3, num=20, dtype=numpy.float64)
x_axis: numpy.ndarray = numpy.linspace(start=1, stop=60, num=20, dtype=numpy.uint16)
