...
x_axis: numpy.ndarray = numpy.linspace(start=40, stop=150, num=5, dtype=numpy.float32)
...
for j, i in enumerate(x_axis):
    ...
    WeightGaussian.set_deviation(90)
    # WeightLinear.set_maximum_distance(200)
    # WeightParabolic.set_maximum_distance(180)
